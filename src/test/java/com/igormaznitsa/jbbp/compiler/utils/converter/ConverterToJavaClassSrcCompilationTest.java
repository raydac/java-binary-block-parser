...
public class ConverterToJavaClassSrcCompilationTest extends AbstractJavaClassCompilerTest {
    ...
    public void testExpression() throws Exception {
        final JBBPParser parser = JBBPParser.prepare("bit:3 bitf; var somevar; bool bbb; long aaa; ubyte kkk; {{int lrn; {int [(lrn/aaa*1*(2*somevar-4))/(100%9>>bitf)&56|~kkk^78&bbb];}}}");
