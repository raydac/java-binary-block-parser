...
public interface JBBPCustomFieldWriter {
   ...
   */
  void writeCustomField(final JBBPOut context, final JBBPBitOutputStream outStream, final Object instanceToSave, final Field instanceCustomField, final Bin fieldAnnotation) throws IOException;
}
