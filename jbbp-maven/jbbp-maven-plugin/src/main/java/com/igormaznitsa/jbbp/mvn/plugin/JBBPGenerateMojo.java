...
import com.igormaznitsa.jbbp.mvn.plugin.converters.ParserFlags;
...
import static com.igormaznitsa.jbbp.mvn.plugin.utils.Utils.getEncoding;
...
public class JBBPGenerateMojo extends AbstractJBBPMojo {
    ...
    protected void executeMojo() throws MojoExecutionException, MojoFailureException {
        ...
        final Set<File> foundJBBPScripts = findSources(this.outputDirectory);
